...
export function IntegrationsPage() {
  ...
  const createPapiWebhookMutation = trpc.workspace.createPapiWebhook.useMutation({ onSuccess: async () => { setInstanceId(""); setWebhookName(""); await papiConfigQuery.refetch(); }, });
